...
Yes! Tap "Add item..." at the top of your shopping list to add any item manually.

### Pantry & Recipes

**What does "What Can I Make?" do?**
This feature searches for recipes that use ingredients currently in your pantry, helping you reduce food waste and save money.

**How do I filter recipes?**
In the Discover tab, tap the filter icon to filter by cuisine, cook time, calories, protein, dietary restrictions, and more.

### Subscription & Account

**What's included in Premium?**
Premium includes unlimited meal plan generation, advanced recipe filters, price tracking, and priority access to new features.

**How do I cancel my subscription?**
Subscriptions are managed through your Apple ID. Go to Settings > Apple ID > Subscriptions > Stockpot to manage or cancel.

**How do I restore my purchase?**
Go to Settings in the app and tap "Restore Purchases."

## Contact Us

Have a question not answered here? We'd love to help!
